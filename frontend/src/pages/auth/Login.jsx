...
const Login = () => {
  ...
  // Test function for different roles
  const testLogin = (role) => {
    const testEmails = {
      collector: 'collector@example.com',
      departmentHead: 'department@example.com', 
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      {/* TEMPORARY: Add test buttons for debugging - remove in production */}
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed top-4 left-4 z-50 bg-black/80 p-4 rounded-lg backdrop-blur-sm">
          <div className="text-white text-sm mb-2">Test Logins:</div>
          <div className="flex gap-2 flex-wrap">
            <button 
              onClick={() => testLogin('collector')}
              className="px-3 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700"
            >
              Collector
            </button>
            <button 
              onClick={() => testLogin('departmentHead')}
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{ animationDelay: '2000ms' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-cyan-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{ animationDelay: '4000ms' }}></div>
      </div>
        ...
        <div className="text-center max-w-lg z-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10 hover:border-blue-400/30 transition-all duration-300">
              ...
              <h4 className="text-white text-sm font-semibold">Secure Access</h4>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10 hover:border-purple-400/30 transition-all duration-300">
              ...
              <h4 className="text-white text-sm font-semibold">Role Management</h4>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10 hover:border-green-400/30 transition-all duration-300">
              ...
              <h4 className="text-white text-sm font-semibold">Smart Reports</h4>
            </div>
          </div>
