      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">{user?.name || 'Department Head'}</h1>
                <p className="text-gray-600">Department Head Profile</p>
              </div>
            </div>
            <button 
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="border-b border-gray-200 px-8 py-6">
            ...
            <p className="text-gray-600 text-sm mt-1">Manage your department head profile details</p>
          </div>
                ...
                <div className="px-4 py-3 bg-purple-50 rounded-xl border border-purple-200">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-purple-700 font-semibold">
                      {user?.department || 'Head Department'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="px-4 py-3 bg-blue-50 rounded-xl border border-blue-200">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-blue-700 font-semibold">Department Head</p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 mt-8 p-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Department Head Information</h3>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 mt-8 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-purple-50 rounded-xl border border-purple-200">
              ...
              <div className="text-sm text-purple-700 font-medium">Reports This Month</div>
            </div>
          </div>
        </div>
      </div>
