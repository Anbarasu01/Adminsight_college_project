  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-500 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-40 -left-32 w-80 h-80 bg-yellow-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
          style={{ animationDelay: "2000ms" }}
        ></div>
        <div
          className="absolute top-40 left-1/2 w-80 h-80 bg-green-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
      ...
      <div className="relative z-10">
          ...
          <div className="text-center">
            ...
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-full mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">
                Trusted by 500+ Government Departments
              </span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-12 leading-relaxed">
              ...
              Streamline problem reporting, resource management, and citizen
              engagement.
            </p>

            {/* User Type Selection - CRITICAL ADDITION */}
            {/* User Type Selection - GO DIRECTLY TO DASHBOARDS */}
            <div className="max-w-3xl mx-auto bg-white/10 backdrop-blur-sm rounded-3xl p-8 mb-12 border border-white/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-white/70 text-sm mb-4">
                      Collect field data, update status
                    </p>
              ...
              <div className="mt-8 pt-6 border-t border-white/20 text-center">
                <p className="text-white/80 mb-4">
                  Want to report a problem without account?
                </p>
                <Link
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group">
              ...
              <Link
                to="/public/dashboard"
                className="inline-block mt-4 text-blue-300 hover:text-blue-200 font-medium"
              >
            ...
            {[
              {
                step: "01",
                title: "Report Issue",
                desc: "Public users submit problem details",
                icon: "📝",
                link: "/public/report-problem",
              },
              {
                step: "02",
                title: "Auto Assignment",
                desc: "System assigns to relevant department",
                icon: "🤖",
              ...
              },
              {
                ...
                desc: "Real-time updates on resolution status",
                icon: "📱",
              ...
              },
              {
                ...
                desc: "Get notified when issue is resolved",
                icon: "✅",
                link: "/public/dashboard",
              },
            ].map((item, index) => (
        ...
        <div className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
            Select your role to go directly to the appropriate dashboard
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <p className="text-white/70 text-sm">
                  Smart governance platform for efficient public service
                  delivery.
                </p>
              </div>
